...
export class GeminiParser {
  ...
  async parse(input: {
    ...
    const prompt = [
      ...
      'Para consultas como "cuánto queda en comida" o "disponible de transporte", usá availability y completá category con la categoría consultada.',
      ...
      'Si el usuario dice que pagó/gastó con tarjeta de crédito, usá register_credit_card_expense y completá creditCard.name. No lo clasifiques como register_expense aunque diga "gasté".',
      'Los gastos con tarjeta de crédito se cargan ahora pero se proyectan como gasto fijo del mes siguiente; no consumen categorías del mes actual.',
      ...
      'Clasificá como confirm respuestas breves de confirmación o decisión pendiente como "confirmo", "crear categoría", "crear", "nueva" o "varios".',
